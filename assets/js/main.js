...
$("#click").click(function() {
			...
			if($("#frame_imgs").is(":visible")){
				$("#frame_imgs").fadeOut(1000);
			}else{
				$("#frame_imgs:hidden").fadeIn(1000);
			}
		});
...
$("#click").click(function() {
  		$("#baner_3D").toggleClass("offf");
		});
//		var nav = document.getElementsByClassName('top_panel')[0];
...
(function($){
    $.fn.viewportChecker = function(useroptions){
        ...
        this.checkElements = function(){
            ...
            $elem.each(function(){
                ...
                if (String(objOptions.offset).indexOf("%") > 0)
                    objOptions.offset = (parseInt(objOptions.offset) / 400) * boxSize.height;
		...
		$(document).ready(function() {
			$(' .slaid_r ').viewportChecker();
			$(' .slaid_l ').viewportChecker();
		});
